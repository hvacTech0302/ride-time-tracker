...
import headerImage from "../../../assets/images/Hero/Disneyland/Disneyland-Hero.jpg";
import LandsSection from "../../../components/LandsSection/LandsSection.component";
import "./disneylandPark.styles.css";

const DisneylandPark = () => {
  const disneyPark = true; // Set for styling
  const universalPark = false; // Set for styling
  const parkId = 16; // Set to appropriate Park ID.
